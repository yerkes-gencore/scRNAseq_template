---
title: "`r project_name`: Report `r report_number` - Pseudbulk QC, DE & GSEA"
author: |
  | `r report_author`
  | ENPRC Genomics Core
date: "`r Sys.Date()`"
...
### 2.4.2 - Heatmaps of top `r n_genes` genes for each contrast
...
### 2.4.3 - Tables of significant genes for each contrast {.tabset}
