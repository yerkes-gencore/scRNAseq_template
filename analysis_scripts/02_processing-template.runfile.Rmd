...
```{r, fig.width=12, fig.height=8}
umaps.rna[["nGene_RNA"]] <- objs %>%
  plotUMAP_split(., feature = "nGene_RNA", label.size=0, legend = T, reduction = 'umap')

umaps.rna[["nGene_RNA"]] <- ggarrange(plotlist = umaps.rna[["nGene_RNA"]], ncol=5, nrow=3, 
          common.legend = T, legend = "right") %>%
  annotate_figure(top = ggpubr::text_grob("nGene_RNA", face = "bold", size = 14))
```
