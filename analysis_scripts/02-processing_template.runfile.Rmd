...
ggarrange(plotlist = umaps.rna[["Phase"]], ncol=6, nrow=6, 
          common.legend = T, legend = "right") %>%
...
```{r, message=FALSE, warning=FALSE, fig.width=12, fig.height=12}
umaps.rna[["post_CC_regression"]] <- objs %>%
  plotUMAP_split(., group.by = "Phase", label.size=0, legend = T, reduction = 'GEX_UMAP')

ggarrange(plotlist = umaps.rna[["post_CC_regression"]], ncol=6, nrow=6, 
          common.legend = T, legend = "right") %>%
  annotate_figure(top = ggpubr::text_grob("Phase", face = "bold", size = 14))
```
...
ggarrange(plotlist = umaps.rna[["nFeature_RNA"]], ncol=5, nrow=3, 
          common.legend = T, legend = "right") %>%
...
ggarrange(plotlist = umaps.rna[["nCount_RNA"]], ncol=5, nrow=3, 
          common.legend = T, legend = "right") %>%
...
ggarrange(plotlist = umaps.rna[["log10GenesPerUMI"]], ncol=5, nrow=3, 
          common.legend = T, legend = "right") %>%
...
ggarrange(plotlist = umaps.rna[["riboRatio"]], ncol=5, nrow=3, 
          common.legend = T, legend = "right") %>%
...
ggarrange(plotlist = umaps.rna[["mitoRatio"]], ncol=5, nrow=3, 
          common.legend = T, legend = "right") %>%
