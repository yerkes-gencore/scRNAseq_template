...
objs_filt <- lapply(objs, subset, subset = outliers)
rm(objs)
...
```{r}
saveRDS(objs_filt, here('saved_rds/report-02/objs_filt.Rds'))
objs_filt <- readRDS(here('saved_rds/report-02/objs_filt.Rds'))
```
