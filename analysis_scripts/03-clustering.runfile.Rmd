...
c(obj_filt_mapped, singler_out) %<-% runSingleR(obj, 
...
hpca_facet_plot <- plotRefMapScoresFacet(obj,
...
```{r, fig.height=8}
heatmaps.adt <- featureHeatmapByCluster(obj, title = 'ADT Data by cluster', assay = 'ADT')
heatmaps.adt
```
