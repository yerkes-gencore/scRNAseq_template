...
podman build -t yerkesgencore/gencore-singlecell-rstudio
:<your r version here> .
```
...
```
podman build yerkesgencore/gencore-singlecell-rstudio
```
...
```
podman run -e PASSWORD=password -e ROOT=TRUE -p 8787:8787 yerkesgencore/gencore-singlecell-rstudio
```
